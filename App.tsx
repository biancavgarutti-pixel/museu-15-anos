...
const App: React.FC = () => {
  const [selectedConsole, setSelectedConsole] = useState<ConsoleOption | null>(null);
  ...
  const handleImageUpload = async (file: File) => {
    ...
    try {
      ...
      console.error(err);
      setErrorMsg("Ops! A Nano Banana escorregou em um pixel. Tente novamente.");
      ...
      <header className="relative w-full min-h-[60vh] flex flex-col items-center justify-center overflow-hidden border-b-4 border-purple-900 bg-black py-16">
        ...
        <div className="relative z-10 text-center px-4 w-full max-w-5xl mx-auto flex flex-col items-center">
            ...
            {!imageError ? (
              ...
              <div className="animate-fade-in">
                ...
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-retro leading-snug md:leading-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)]">
                  MUSEU DO VIDEOGAME<br/>ITINERANTE
                </h1>
              </div>
            )}
          </div>
          ...
          <p className="text-lg md:text-2xl text-slate-300 max-w-3xl mx-auto font-light tracking-wide">
            Viaje no tempo através dos pixels. <br className="hidden md:block" />Descubra sua versão na história dos games.
          </p>
        </div>
      </header>
            ...
            <div className="p-1 bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500">
               <div className="bg-slate-950 p-6 md:p-12 text-center">
                 ...
                 <div className="relative inline-block group">
                   <div className={`absolute -inset-1 bg-gradient-to-r ${selectedConsole.gradient.replace('bg-', 'from-')} to-pink-600 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200`}></div>
                 ...
                 <div className="mt-10 flex flex-col md:flex-row gap-4 justify-center">
                   ...
                   >
                     <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                       <path fillRule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v3.25a1 1 0 11-2 0V13.011a7.002 7.002 0 01-11.378-2.618 1 1 0 01.61-1.276z" clipRule="evenodd" />
                     </svg>
                     JOGAR NOVAMENTE
                   </button>
                 </div>
